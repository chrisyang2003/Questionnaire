...
const install = (Vue, vm) => {
	...
	vm.$api.config 				= async (params = {}) => await vm.$u.get('http://chrisyy.top:5000/addons/booking/common/init', params);
	...
	vm.$api.houseList			= async (params = {}) => await vm.$u.get('http://chrisyy.top:5000/addons/booking/house/houseList', params);
	vm.$api.houseDetail			= async (params = {}) => await vm.$u.get('http://chrisyy.top:5000/addons/booking/house/detail', params);
	vm.$api.houseBooking		= async (params = {}) => await vm.$u.post('http://chrisyy.top:5000/addons/booking/house/booking', params);
	...
	vm.$api.storeDetail	    	= async (params = {}) => await vm.$u.get('http://chrisyy.top:5000/addons/booking/store/detail', params);
	vm.$api.getDefaultStore	    = async (params = {}) => await vm.$u.get('http://chrisyy.top:5000/addons/booking/store/defaultStore', params);
